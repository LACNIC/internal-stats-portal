...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('notes', models.CharField(max_length=255, unique=True, verbose_name='notas')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified', models.DateTimeField(verbose_name='\xfaltima modificaci\xf3n')),
                ('started', models.DateTimeField(null=True, verbose_name='primera generaci\xf3n de los datos')),
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='publication_creator', to=settings.AUTH_USER_MODEL, verbose_name='creador')),
                ...
                ('responsibles', models.ManyToManyField(related_name='publication_responsible', to=settings.AUTH_USER_MODEL, verbose_name='responsables')),
            ],
            options={
