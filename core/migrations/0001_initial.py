...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('notes', models.TextField(blank=True, null=True, unique=True, verbose_name='notas')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_value', models.PositiveSmallIntegerField(blank=True, null=True, verbose_name='valor de actualizaci\xf3n de datos')),
                ('update_type', models.CharField(blank=True, choices=[('mins', 'Minuto/s'), ('hours', 'Hora/s'), ('days', 'Dia/s'), ('months', 'Mes/es'), ('years', 'A\xf1o/s')], max_length=10, null=True, verbose_name='tipo de valor de actualizaci\xf3n de datos')),
                ...
                ('creator', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='core_publication_creator', to=settings.AUTH_USER_MODEL, verbose_name='creador')),
                ...
                ('responsibles', models.ManyToManyField(related_name='core_publication_responsible', to=settings.AUTH_USER_MODEL, verbose_name='responsables')),
            ],
            options={
